...
syn keyword sqlPyGenDirective module schema query params return from import
syn keyword sqlPyGenKnownTypes str int float

" Comments (c-style, mysql-style and modified sql-style)
syn region mysqlComment          start="/\*"  end="\*/"
syn match mysqlComment           "#.*"
syn match sqlPyGenAnnotation           "--\_s.*" contains=sqlPyGenDirective,sqlPyGenKnownTypes
...
hi def link sqlPyGenDirective       PreProc
hi def link sqlPyGenKnownTypes      Type


let b:current_syntax = "sqlpygen"
